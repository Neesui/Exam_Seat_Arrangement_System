...
const ViewCoursePage = () => {
  ...
  return (
    <div className="ml-8 mt-20 bg-white p-6 rounded-lg shadow-md w-[77vh] max-w-screen-lg mx-auto">
      ...
      {isLoading ? (
        ...
        <table className="w-[70vh] border-collapse border border-gray-200">
          <thead>
          ...
          <tbody>
            {/* Access data.courses array instead of data */}
